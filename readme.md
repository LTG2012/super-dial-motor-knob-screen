...
选到设置界面-wifi-AP，长按启动热点，连接SuperDial-XXXXXX的wifi，打开浏览器访问192.168.4.1，选中wifi名称，填入密码和六位验证码(需要在验证码网站获取)
![wifi](image/wifi.png)

在验证码网站中需要输入wifi名称最后六位字符，例如：SuperDial-453D84，网站输入`453D84`得到六位验证码“xxxxxx”，每人能获取两次验证码

[验证码获取网站:http://154.23.185.66](http://154.23.185.66)，验证码获取后需要自行保存,网页不做保存，点确定后就消失

个人制作两个以上需要获取验证码的可以加入本末尾的交流群，联系管理员说明来意（不要找群主，他只是开千人QQ群的工具人
## 源码
